...
namespace ExamSystemAPI.Migrations
{
    ...
    [Migration("20250415124908_AddErrorRecord")]
    partial class AddErrorRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamSystemAPI.Model.ErrorRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("T_ErrorRecords", (string)null);
                });

            modelBuilder.Entity("ExamSystemAPI.Model.ExamRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("T_ExamRecords", (string)null);
                });
            ...
            modelBuilder.Entity("T_Papers_Topics", b =>
                {
                    ...
                    b.Property<long>("TopicIndex")
                        .HasColumnType("bigint");

                    b.Property<long>("TopicSetIndex")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ExamSystemAPI.Model.ErrorRecord", b =>
                {
                    b.HasOne("ExamSystemAPI.Model.Topic", "Topic")
                        .WithMany()
            ...
            modelBuilder.Entity("ExamSystemAPI.Model.Team", b =>
                {
                    b.HasOne("ExamSystemAPI.Model.User", "CreateUser")
                        .WithMany()
