...
namespace ExamSystemAPI.Model.DbContexts
{
    public class TopicConfig : IEntityTypeConfiguration<Topic>
    {
        public void Configure(EntityTypeBuilder<Topic> builder)
        {
            ...
            builder.Property(t => t.Column1).HasMaxLength(512).IsRequired(false);
            builder.Property(t => t.Column2).HasMaxLength(512).IsRequired(false);
            builder.Property(t => t.Column3).HasMaxLength(512).IsRequired(false);
            builder.Property(t => t.Column4).HasMaxLength(512).IsRequired(false);
            builder.Property(t => t.Column5).HasMaxLength(512).IsRequired(false);
            builder.Property(t => t.Column6).HasMaxLength(512).IsRequired(false);
